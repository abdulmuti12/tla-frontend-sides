...
export async function GET(_request: Request, { params }: { params: { id: string } }) {
  ...
  return NextResponse.json({
    data: {
      ...
      url: desktopExists ? `/360/desktop/${baseName}.webp` : `/360/mobile/${baseName}.webp`,
      desktopUrl: desktopExists ? `/360/desktop/${baseName}.webp` : '',
      mobileUrl: mobileExists ? `/360/mobile/${baseName}.webp` : '',
    },
  });
}
